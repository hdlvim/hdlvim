...
if dap and dapui and vt then
  ...
  if cfg.lua and cfg.lua.enable then
    require("main.dap.nvim-dap.config.lua").setup()
  end
  ...
  --   require("main.dap.nvim-dap.config.cpp").setup()
  -- end

  if cfg.frontend and cfg.frontend.enable then
    require("main.dap.nvim-dap.config.vscode-js")
  end

  require("main.dap.nvim-dap.common-config").keyAttach()
end
