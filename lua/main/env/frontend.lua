...
return function(config)
  return {
    ...
    getLSPConfigMap = function()
      local list = {
        tsserver = require("main.lsp.config.typescript"),
        cssls = require("main.lsp.config.css"),
        emmet_ls = require("main.lsp.config.emmet"),
        html = require("main.lsp.config.html"),
      }
      if config.tailwindcss then
        list.tailwindcss = require("main.lsp.config.tailwindcss")
      end
      if config.vue then
        list.volar = require("main.lsp.config.volar")
      end
      if config.prisma then
        list.prismals = require("main.lsp.config.prismals")
      end
